class ApplicationController < ActionController::Base
  ...
  private
    ...
    def set_access_control_headers
      headers['Access-Control-Allow-Origin'] = (['web.gt.shelby.tv', 'gt.shelby.tv', 'isoroll.shelby.tv', 'shelby.tv', 'unicorn.shelby.tv', 'localhost.shelby.tv:3000', 'm.localhost.shelby.tv:3000', '192.168.2.206:3000'].include?(request.domain) ? request.domain : '*')
