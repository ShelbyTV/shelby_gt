...
if current_user == @user
	...
	child :preferences => "preferences" do
		attributes :email_updates, :like_notifications, :like_notifications_ios, :watched_notifications, :comment_notifications, :upvote_notifications, :reroll_notifications, :roll_activity_notifications, :open_graph_posting
	end
