...
if @include_frame_children
  ...
  attributes :id, :score, :upvoters, :view_count, :frame_ancestors, :frame_children, :creator_id, :conversation_id, :roll_id, :video_id, :like_count, :frame_type, :original_source_url
