  ...
  describe 'like notifications' do
    ...
    context "shelby user liker" do
      ...
      it 'should have a link to the sending user' do
        @email.body.encoded.should have_tag(:a, :with => { :href => "#{Settings::Email.web_url_base}/user/#{@user_from.id}/personal_roll" })
    ...
    context "anonymous liker" do
      ...
      it 'should contain the like message' do
        @email.body.encoded.should match("Someone anonymously liked \"#{@frame.video.title}\"")
      end
    end
  end
