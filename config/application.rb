...
module ShelbyGt
  class Application < Rails::Application
    ...
    config.middleware.use Rack::Cors do
      allow do
        origins 'web.gt.shelby.tv', 'gt.shelby.tv', 'isoroll.shelby.tv', 'https://shelby.tv', 'shelby.tv', 'https://fb.shelby.tv','fb.shelby.tv', 'm.shelby.tv', 'staging.shelby.tv', 'localhost.shelby.tv:3000', '192.168.2.206:3000', '192.168.2.190:3000', 'm.localhost.shelby.tv:3000'
        resource %r{/v1/(beta_invite|conversation|dashboard|discussion_roll|frame|gt_interest|roll|twitter|user|video)\w*},
