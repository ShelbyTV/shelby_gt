...
module ShelbyGt
  class Application < Rails::Application
    ...
    config.middleware.use Rack::Cors do
      allow do
        origins 'web.gt.shelby.tv', 'gt.shelby.tv', 'isoroll.shelby.tv', 'https://shelby.tv', 'shelby.tv', 'https://fb.shelby.tv','fb.shelby.tv', 'm.shelby.tv', 'staging.shelby.tv', 'localhost.shelby.tv:3000', '192.168.2.22:3000', '192.168.2.190:3000', 'm.localhost.shelby.tv:3000', "watchthiswith.me"
        resource %r{/v1/(beta_invite|conversation|dashboard|discussion_roll|frame|gt_interest|js_err|prioritized_dashboard|remote_control|roll|twitter|user|video)\w*},
    ...
    config.after_initialize do
      ...
      if settings['db_hosts']
        ...
        conn = Mongo::MongoReplicaSetClient.new( settings.db_hosts, {}.merge(settings.db_options.merge(Settings::Mongo.db_options)) )
      else
        conn = Mongo::MongoClient.new(settings.db_host, settings.db_port, {}.merge(settings.db_options.merge(Settings::Mongo.db_options)) )
      end
