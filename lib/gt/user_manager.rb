  ...
  class UserManager
    ...
    def self.get_or_create_faux_user(nickname, provider, uid, options = {})
      ...
      if u = User.first( :conditions => { 'authentications.provider' => provider, 'authentications.uid' => uid } )
        ...
        ensure_users_special_rolls(u, true, provider, nickname)
    ...
    def self.ensure_users_special_rolls(u, save=false, origin_network=nil, origin_creator_nickname=nil)
      build_public_roll_for_user(u, origin_network, origin_creator_nickname) unless u.public_roll
    ...
    private
      ...
      def self.build_public_roll_for_user(u, origin_network=nil, origin_creator_nickname=nil)
        r = Roll.new
        r.creator = u
        r.public = true
        ...
        r.origin_creator_nickname = origin_creator_nickname if origin_creator_nickname
        u.public_roll = r
      end
